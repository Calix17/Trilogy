# The Final Decision — start here

Complete project package, consolidated 24 September 2026.

**The latest documentation is inside this ZIP.** It includes the current working text, prior manuscript editions, reading PDFs, artwork, the bible, characters, reviews, philosophical development, source notes, and open decisions. Distinct historical files recovered during the audit are kept in the archive.
...
| [Vessel and trilogy philosophy](06-development-notes/v7-vessel-and-trilogy-philosophy-2026-09-24.md) | Two-room Vessel, Haven's poetic account, ten-year access, and Book II's development-facility gala. |

## Session coverage guide

| Discussion or decision | Main record inside this ZIP |
| --- | --- |
| Original outlines, draft-one corrections, and early design proposals | [Draft-one review](06-development-notes/draft-1-editorial-review.md), [early design notes](06-development-notes/provisional-design-notes-longevity-reality-ark.md), and source/history archives. |
| Daniel's voluntary absence, extended life, perfect research setting, and family cost | [Author clarifications](06-development-notes/author-clarifications-2026-09-22.md), [v6 development path](06-development-notes/v6-development-path-2026-09-23.md), and current bible. |
| Elias's habitat-engineering profession; Daniel's theoretical interests and warm shared research | [Character profiles](04-characters/v6-character-profiles-2026-09-23.md), [current character sheets](04-characters/character-sheets.md), and v7 prose. |
| Ruth's hidden letter, forgiveness, death with family, key/chain, and Daniel's stone | [Daniel's letter record](06-development-notes/v6-daniels-letter-2026-09-23.md), current bible, and v7 prose. |
| Ambiguous crossing, clinical-seeming Institute, Hesk/Rana, ordinary room, and spaced dreams | [Post-v4 notes](06-development-notes/post-v4-author-notes-2026-09-23.md), [v6 scene/clue outline](06-development-notes/v6-chapter-and-clue-outline-2026-09-24.md), and v7 prose. |
| Institute support ads versus the unknown sender's car, call, and physical completing page | [Contact strategy](06-development-notes/v6-contact-strategy-2026-09-24.md), current bible, and v7 checklist. Historical proposals are labelled. |
| Nested map scales, university delivery, ten-year openings, and split-message cause still open | Current bible and S-01/S-02 in the [revision checklist](06-development-notes/v7-revision-checklist-2026-09-24.md). |
| Haven's three worlds, poetic revelation, sparse Vessel, ultimate-reality uncertainty | [Vessel record](06-development-notes/v7-vessel-and-trilogy-philosophy-2026-09-24.md), current bible, and v7 prose. |
| Father–son farewell, notebook custody, ordinary breakfast, toast house/rocket, gratitude | V7 prose and applied changes in the revision checklist. |
| External v6 assessment, publication claims, proposed early science-fiction cues, cover/art issues | [External review assessment](06-development-notes/v6-external-review-assessment-2026-09-24.md) and v7 checklist. Earlier praise is review history, not a guarantee of publication readiness. |
| Book II: Haven's bomb, generation-ship facility gala, conspiracy, impersonation, and moral costs | [Plot clarifications](06-development-notes/plot-clarifications-and-mystery-boundaries-2026-09-22.md), [Books I/II synopsis](06-development-notes/current-plot-summary-books-one-and-two.md), current bible, and S-04. |
| Book II: neglected defense, storm plus approaching asteroid, neural VR losses, illegal server | Plot clarifications, current bible, philosophy scene map, and S-05. |
| Autonomous miners, compact ascension Ark priority, later embodied ship, Jonah's beacon | Plot clarifications, current bible, and Books I/II synopsis. |
